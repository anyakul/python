...
def get_res_str(id_player, nums):
    if check_win(nums) == True:
        return f'Выиграл {id_player}. Наберите /play чтобы играть снова'
    elif check_draw(nums) == True:
        return 'Ничья. Наберите /play чтобы играть снова'
