...
def draw_keyboard():
    ...
    six_k = telebot.types.InlineKeyboardButton(text='9', callback_data='6')
    seven_k = telebot.types.InlineKeyboardButton(text='6', callback_data='7')
    eight_k = telebot.types.InlineKeyboardButton(text='7', callback_data='8')
    nine_k = telebot.types.InlineKeyboardButton(text='8', callback_data='9')
